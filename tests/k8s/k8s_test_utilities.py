...
def is_service_running(duthost, feature):
    container_id = check_running_container_id(duthost, feature)
    return duthost.is_service_fully_started(service_id)
...
def check_running_container_id(duthost, feature):
    ...
    """
    feature_data = duthost.shell('show feature status {} | grep {}'.format(feature, feature))["stdout_lines"]
